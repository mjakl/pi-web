  ...
  const components = useMemo<Components>(
    () => ({
          ...
          if (lang === "mermaid") {
            return (
              <MermaidBlock
                ...
                defaultPreview={mermaidDefaultPreview}
              />
            );
          }
          return (
      ...
      a({ href, children, ...props }) {
        ...
        if (href?.startsWith("#")) {
          return (
            <a href={`#user-content-${href.slice(1)}`} {...props}>
              {children}
            </a>
          );
        }
        const filePath = onOpenFile
          ? resolveLocalFileHref(href, linkBase, cwd ?? linkBase)
          : null;
      ...
      img({ src, alt, ...props }) {
        ...
        const filePath =
          typeof src === "string"
            ? resolveLocalFileHref(src, linkBase, cwd ?? linkBase)
            : null;
