...
export function AppShell({ homeDir }: { homeDir: string }) {
  ...
  const selectedMetadataAuthorityRef =
    useRef<SelectedSessionMetadataAuthority | null>(null);
  const beginSessionInventoryAttempt = useCallback(
    () => ++inventoryAttemptRef.current,
    [],
  );
  const handleSessionsChange = useCallback(
    (sessions: SessionInfo[], inventoryAttempt: number) => {
  ...
  const [chatDisplay, setChatDisplay] =
  ...
  const contextWarningLevel = getContextWarningLevel(
    contextUsage,
    dumbZoneTokens,
  );
      ...
      <button
        ...
        style={{
          ...
          background: mobileBanner
            ? "color-mix(in srgb, var(--warning) 8%, var(--bg-panel))"
            : "none",
          border: "none",
  ...
  const renderSessionStatsButton = (mobile: boolean) => {
    ...
    else if (contextWarningLevel === "yellow")
      ...
      >
        {mobile ? (
          <>
            ...
            {contextStats && (
              <span
                className="mobile-session-context"
            ...
            >
              ...
              {isMobile && (
                ...
                >
                  ...
                  <CompactButton
                    control={showChat ? compactionControl : null}
                    warning={contextWarningLevel !== "none"}
                    hidden={isNarrowMobile && mobileToolbarMoreOpen}
                  />
              ...
              {activeTopPanel && topPanelPos && (
                ...
                >
                  ...
                  {activeTopPanel === "session" && (
                    <div
                      className="session-info-popover menu-surface"
                      style={{
                        padding: "12px 16px",
                      }}
                    >
                        ...
                        (() => {
                          ...
                          const messageRows = [
                            [
                              ...
                              sessionStats.userMessages.toLocaleString("en"),
                            ],
                            [
                            ...
                            [
                              ...
                              sessionStats.toolCalls.toLocaleString("en"),
                            ],
                            [
                              translate("session.toolResults"),
                              sessionStats.toolResults.toLocaleString("en"),
                            ],
                            [
                              translate("session.total"),
                              sessionStats.totalMessages.toLocaleString("en"),
                            ],
                          ];
                          const tokenRows = [
                            [
                              translate("session.input"),
                              sessionStats.tokens.input.toLocaleString("en"),
                            ],
                            [
                              translate("session.output"),
                              sessionStats.tokens.output.toLocaleString("en"),
                            ],
                            ...
                            [
                              translate("session.total"),
                              sessionStats.tokens.total.toLocaleString("en"),
                            ],
                          ];
                          const extraTokenRows = [
                            ...(contextStats
                              ? [
                                  [
                                    translate("session.contextWindow"),
                                    contextStats.size,
                                  ],
                                  [
                                    translate("session.contextUsage"),
            ...
            {showChat ? (
              <ChatWindow
                ...
                sessionActive={Boolean(
                  selectedSession && activeSessionIds.has(selectedSession.id),
                )}
