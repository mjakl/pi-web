...
test("streams exact row metadata and collapses a skill expansion before truncating", async (t) => {
  ...
  await writeFile(filePath, [
    ...
    line({ type: "custom", customType: "pi-web:subagent-result", id: "r1", parentId: "n2", timestamp: "2026-01-01T00:00:06.000Z", data: { status: "completed" } }),
    "",
  ].join("\n"));
  ...
  assert.equal(metadata?.subagentStatus, "completed");
});
