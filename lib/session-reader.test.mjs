...
test("session inventory reads only bounded identity and relation data", async (t) => {
  ...
  writeFileSync(filePath, [
    ...
    "x".repeat(512 * 1024),
    JSON.stringify({
      type: "custom", customType: "pi-web:subagent-result", id: "result",
      parentId: "meta", timestamp: "2026-01-01T00:00:01.000Z",
