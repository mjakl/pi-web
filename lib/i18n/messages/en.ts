...
export const enMessages: Record<string, string> = {
  ...
  "chat.subagent.captureTruncated":
    "Earlier or oversized messages were omitted during capture.",
  ...
  "sidebar.clearStars": "Clear all stars",
  "sidebar.clearStarsFailed": "Could not clear stars: {error}",
  ...
  "chat.rewind": "Rewind",
  "chat.rewindTitle":
    "Rewind — remove this message and later history, then edit it again",
  ...
  "chat.noActiveSessionForQueuedMessage":
    "No active session for the queued message",
  ...
  "chat.agentStreamConnectFailed":
    "Could not connect to the agent event stream. Please try again.",
