...
export const enMessages: Record<string, string> = {
    ...
    "chat.subagent.cancelled": "Cancelled",
    "chat.subagent.unknown": "No result",
    "chat.subagent.running": "Running",
    "chat.subagent.count.completed": "{count} completed",
    "chat.subagent.count.failed": "{count} failed",
    "chat.subagent.count.cancelled": "{count} cancelled",
    "chat.subagent.count.unknown": "{count} without result",
    "chat.subagent.result": "Result",
    "chat.subagent.prompt": "Prompt",
    "chat.subagent.runDetails": "Run details",
    "chat.subagent.rawInput": "Raw input",
    "chat.subagent.rawOutput": "Raw output",
    "chat.subagent.agent": "Agent",
    "chat.subagent.model": "Model",
    "chat.subagent.cwd": "Working directory",
    "chat.subagent.initialContext": "Requested initial context",
    "chat.subagent.session": "Session",
    "chat.subagent.handled": "Prompt handled without an agent response.",
    "chat.subagent.noOutput": "No output.",
    "chat.subagent.captureTruncated": "Earlier or oversized messages were omitted during capture.",
    ...
    "settings.dumbZone": "Dumb zone",
    "settings.dumbZoneDescription": "Highlight context usage and Compact when the current context reaches this many tokens.",
    "settings.dumbZoneTokenThreshold": "Token threshold",
    "settings.toolSelection": "Tool selection",
    "settings.toolSelectionDescription": "Choose tools for the current session and future sessions.",
    ...
    "skills.mode.modelVisible": "Model-visible",
    "skills.mode.manual": "Manual",
    ...
    "sidebar.sessionActive": "Session active",
    "sidebar.sessionStopped": "Session stopped",
    "sidebar.newActivity": "New activity",
    "sidebar.unreadSessionStatus": "{status} · New activity",
    ...
    "files.loadFailed": "Failed to load files (HTTP {status})",
    "files.uploadNetworkError": "Network error while uploading files",
    "files.uploadCancelled": "Upload cancelled",
    "files.uploadFailed": "Upload failed (HTTP {status})",
    "files.uploadCheckFailed": "Upload check failed (HTTP {status})",
    ...
    "chat.mobileMessagePlaceholder": "Message…",
    "chat.composerSettings": "Session controls",
    "chat.extensionStatus": "Extension status",
    "chat.steer": "Steer",
    "chat.queue": "Queue",
    "chat.queueTitle": "Queue after the agent finishes (Option/Alt)",
    "chat.modelAndReasoning": "Model and reasoning",
    ...
    "chat.commandSession": "Show session message and token stats",
    ...
    "chat.extensionCommandFailed": "Extension command failed",
    "chat.switchModelFailed": "Failed to switch model: {error}",
    "chat.noActiveSessionToCompact": "No active session to compact",
    "chat.compactedContext": "Compacted context",
    "chat.noActiveSessionToReload": "No active session to reload",
    "chat.reloadedSessionResources": "Reloaded session resources",
    "chat.noActiveSessionToName": "No active session to name",
    "chat.nameUsage": "Usage: /name <name>",
    ...
    "chat.clonedSessionBranch": "Cloned current session branch",
    "chat.noActiveSessionForQueuedMessage": "No active session for the queued message",
    "chat.recallQueuedFailed": "Failed to recall queued messages",
    "chat.promptSessionUnavailable": "Unable to create a session for the prompt",
    "chat.noActiveSessionForPrompt": "No active session for the prompt",
    "chat.shellSessionUnavailable": "Unable to create a session for the shell command",
    "i18n.close": "Close",
    "i18n.copy": "Copy",
    "i18n.copied": "Copied",
    "i18n.cancel": "Cancel",
    ...
    "i18n.noPluginsConfigured": "No plugins configured",
    ...
    "i18n.editFromHereTitle": "New branch — edit this message within the current session",
    "i18n.newSession": "New session",
    "i18n.newSessionTitle": "New session — copy earlier history and edit this message in a separate session",
    ...
    "chat.compaction.labelWithTokens": "Conversation compacted: {tokens}",
    "chat.compaction.expandSummary": "Expand compaction summary",
    "chat.compaction.collapseSummary": "Collapse compaction summary",
    "chat.compaction.tokens": "{before} → ~{after} tokens",
    "chat.compaction.tokensBefore": "{before} tokens before",
    "chat.compaction.tokensAfter": "~{after} tokens after",
    "chat.compaction.tokenEstimate": "Context usage after compaction is estimated, including retained messages.",
    ...
    "i18n.invalidThinkingResponse": "Invalid thinking response",
    "i18n.before": "Before",
    "i18n.after": "After",
