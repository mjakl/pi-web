...
export const enMessages: Record<string, string> = {
    ...
    "models.apiKeyHelpBefore": "Prefix with",
    "models.apiKeyHelpAfter": "to run a shell command, or use an env var name",
    "models.api": "API",
    "models.modelId": "ID *",
    "models.displayNamePlaceholder": "Display name",
    "models.customCompatible": "OpenAI / Anthropic compatible",
    "models.oauthConnected": "Already connected. You can re-login or disconnect.",
    "models.oauthConnect": "Connect your {name} account.",
    "models.oauthPasteRedirect": "Complete sign-in in the browser, then copy the redirect URL from the address bar and paste it below.",
    "models.oauthBrowserFallback": "If the browser window did not open,",
    "models.oauthOpenLoginPage": "click here to open the login page",
    "models.loginValuePlaceholder": "Enter value…",
    "models.apiKeyStored": "API key is stored. Enter a new key below to replace it, or disconnect to remove it.",
    "models.apiKeyEnter": "Enter your {provider} API key to enable {count} model{countSuffix}.",
    "models.apiKeyReplacePlaceholder": "Enter new key to replace…",
    ...
    "i18n.connectionLost": "Connection lost",
    "i18n.verifying": "Verifying…",
    "i18n.continuing": "Continuing…",
    "i18n.serverError": "Server error {status}",
    "i18n.skills": "Skills",
